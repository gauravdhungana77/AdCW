<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Loan.aspx.cs" Inherits="RopeyDVDs.Pages.Loan" %>
    ...
    <div class="container">
        <div class="formdiv">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <asp:DropDownList ID="loantypenumdrop" runat="server">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <asp:DropDownList ID="copynumberdrop" runat="server">
                        <asp:ListItem>Item 1</asp:ListItem>
                        <asp:ListItem>Item 2</asp:ListItem>
                    </asp:DropDownList>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <asp:DropDownList ID="membernumberdrop" runat="server">
                        <asp:ListItem>Item 1</asp:ListItem>
                        <asp:ListItem>Item 2</asp:ListItem>
                    </asp:DropDownList>
                </div>
